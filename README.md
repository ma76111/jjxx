...
### مشكلة ETIMEDOUT / EFATAL في Telegram Polling
...
**الحل:**
1. البوت محدّث تلقائياً للتعامل مع هذه الأخطاء وسيعيد المحاولة
2. تأكد من اتصالك بالإنترنت: `curl https://api.telegram.org`
3. إذا استمرت المشكلة، استخدم: `bash fix-polling.sh`

### مشكلة Babel في Vite Client

إذا ظهرت أخطاء Babel:
```bash
cd web/client
rm -rf node_modules package-lock.json
npm install
pm2 restart client  # أو npm run dev
```

### البوت لا يستجيب

```bash
pm2 logs bot        # عرض السجلات
pm2 restart bot     # إعادة التشغيل
```

## 📱 التشغيل على Termux

راجع الدليل الكامل: [TERMUX_SETUP.md](./TERMUX_SETUP.md)
...
- [DEPLOY.md](./DEPLOY.md) - دليل النشر على السيرفر
- [TERMUX_GUIDE.md](./TERMUX_GUIDE.md) - دليل Termux المفصل
- [TERMUX_SETUP.md](./TERMUX_SETUP.md) - إعداد وحل مشاكل Termux
